class ItemDataHandler:
    ...
    def add_item(self, item_id: int, block_id:int, texture_id:int, name: str, placeable: bool, block_type: int, max_stack: int, max_durability: int, tool_data: list) -> None:
        self.item_data_templates[item_id] = ItemTemplate(item_id, block_id, texture_id, name, placeable, block_type, max_stack, max_durability, tool_data)


class ItemTemplate:
    def __init__(self, item_id: int, block_id:int, texture_id:int, name: str, placeable: bool, block_type: int, max_stack: int, max_durability: int, tool_data: list) -> None:
